...
// #1.1 - run in the console: a will be retrieve to 3 because a it is a global variable in this scope
// funcOne()
// #1.2 What will happen if the variable is declared 
// with const instead of let ? - we will have a type error because we can't change a value of const variable
...
// funcTwo()- it will be undifiend because we don't return anything;
// funcThree()- we will have an alert with a=5 because in funcTwo we redeclared our variable a;

// #2.2 What will happen if the variable is declared 
// with const instead of let ?

//funcThree - a will be =0 because of value of const;
//funcTwo - it will be an error of type because we can't redeclaring const
...
// with const instead of let ? //- the same because we in the scope of function
